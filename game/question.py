...
question_list = [question(["史萊姆們感受到隱藏在身體裡的潛力","將自己複製成____倍"],None,0,1),
                 ...
                 question(["獲得鄰近史萊姆村落的大力相挺!","群眾聚集成____倍了"],None,0,1),
                 question(["現在正是20年來經濟最好的時期!","史萊姆人口成長為____倍了"],None,0,1),
                 ...
                 question(["連日氣溫飆高至38.8度","有____隻史萊姆中暑身亡了"],None,0,3),
                 question(["地板忽然裂開冒出了岩漿!","只有剩下____分之一倍的史萊姆沒被燒死"],None,0,4),
                 question(["社會陷入了經濟大蕭條!","史萊姆的人口只剩下____分之一"],None,0,4),
                 question(["因為附近強者間的決鬥 空間被打到裂開了!","只有剩下____分之一倍的史萊姆沒被吸入次元的裂縫"],None,0,4),
...
doctor_question_list = [question(["將 1 到 50 這 50 個正整數平分成甲乙兩組","每組各 25 個數使得甲組的中位數比乙組的中位數小 1","試問共有幾種分法？"],["C24取12","的平方"],1,0,[["C48取24"],["C24取12"],["C24取12","的平方"]]),
                        ...
                        question(["已知圓上三點 A(0,3)、B(4,3)、C(6,1)","求此圓圓心與直線3x-4y-12=0的距離"],["2/5"],1,0,[["1/2"],["2/5"],["2/3"]]),
                        question(["有10名學生數學成績之算術平均數為56, 標準差4分","已知其中8名成績為50、52、53、54、56、57、60、61", "又另外兩名之成績為a、b, 則|a-b|="],["9"],1,0,[["7"],["8"],["9"]]),
                        question(["將「mathematics」排成一列","使得至少兩個母音(a、e、i)相連的機率為"],["26/33"],1,0,[["25/32"],["26/33"],["27/34"]])
                        ]
